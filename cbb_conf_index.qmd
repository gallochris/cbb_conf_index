...
The intention is to show the raw point differential in leage play only, so you can quickly grasp the performance of certain teams in conference play only. It also includes the current NET rating or at the latest date. 
